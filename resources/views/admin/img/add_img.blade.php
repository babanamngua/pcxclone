   ...
   <section>
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        ...
        <li><a href="{{ route('product.index') }}">Quản lý sản phẩm</a></li>
				<li class="active">Thêm nhà ảnh sản phẩmt</li>
			</ol>
		</div><!--/.row-->
                ...
                <div class="col-md-12 mt-4">
                    @foreach ($img as $img1)
                        <div class="img-container" style="display: inline-block; position: relative;">
                            <img src="{{ asset('storage/img/' . $img1->url_img) }}" class="border p-2 m-3" style="width: 140px; height: 140px; margin:5px;" alt="img">
