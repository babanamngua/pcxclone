                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                              ...
                              <input  name="weight" type="text" class="form-control" placeholder="Cân nặng sản phẩm..." value="{{$product->weight}}">
                          </div>
                          {{-- loai san pham --}}
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="chi_tiet_bv1" name="product_specifications" style="resize: none;" rows="5" class="form-control" >{{ old('description', $product->product_specifications) }}</textarea>
                                      </div> 
                                </div>
