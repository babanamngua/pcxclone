								...
								<table id="table_id" class="table table-striped table-bordered">
									...
									@php $i++; @endphp
										<tr>
											...
											<td> <img src="{{ asset('storage/articles/'. $ar->title.' - '.$ar->id.'/'.$ar->url_img) }}" class="border p-2 m-3" style="filter: drop-shadow(0 0 5px rgb(119, 119, 145));width: 140px; margin:5px;" alt="img"></td> {{--ten--}}
											<td>{{$ar->content}}</td> {{--content--}}
											<td>
												<div class="form-group" style="display: -webkit-inline-box;">
												<a href="{{ route('articles.edit', $ar->id) }}" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
