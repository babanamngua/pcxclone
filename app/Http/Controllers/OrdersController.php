...
class OrdersController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $statusOptions = ['Chưa xác nhận','Đã xác nhận','Đang giao hàng','Đã giao hàng','hoàn thành','Hủy đơn hàng','Đã hoàn lại tiền','Thất bại'];
    ...
    public function destroy($id)
    {
        ...
        $vnpay = VNpayment::where('vnp_TxnRef', $order->order_id)->get();
    ...
    public function orderItemclients($id)
    {
        $this->data['title'] = "trang đơn hàng";
        $cartCount = 0;
